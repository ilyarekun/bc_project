...
class BrainCNN(nn.Module):
    ...
    def train_model(self, train_loader, valid_loader, num_epochs=50, patience=6, delta=0.001, learning_rate=0.001, momentum = 0.9, weight_decay = 0.001, save_path="./braincnn_prototype.weights"):
        """
